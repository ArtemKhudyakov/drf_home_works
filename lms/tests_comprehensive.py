...
class LessonCRUDTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="test_user", email="user@example.com", password="testpass123", role="user"
        )

        self.moderator = User.objects.create_user(
            username="test_moderator", email="moderator@example.com", password="testpass123", role="moderator"
        )

        self.manager = User.objects.create_user(
            username="test_manager", email="manager@example.com", password="testpass123", role="manager"
        )
    ...
    def test_lesson_update_by_other_user(self):
        ...
        other_user = User.objects.create_user(username="other_user", email="other@example.com", password="testpass123")
...
class SubscriptionTest(APITestCase):
    ...
    def setUp(self):
        ...
        # Создаем курс
        self.course = Course.objects.create(name="Test Course for Subscription", description="Test Course Description")
...
class PermissionTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.moderator = User.objects.create_user(
            username="moderator_user", email="moderator@example.com", password="testpass123", role="moderator"
        )

        self.manager = User.objects.create_user(
            username="manager_user", email="manager@example.com", password="testpass123", role="manager"
        )
        ...
        self.lesson = Lesson.objects.create(
            name="Test Lesson", description="Test Lesson Description", course=self.course, owner=self.user
        )
