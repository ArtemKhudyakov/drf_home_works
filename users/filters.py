...
class PaymentFilter(django_filters.FilterSet):
    course = django_filters.ModelChoiceFilter(field_name="paid_course", queryset=Course.objects.all(), label="Курс")
    lesson = django_filters.ModelChoiceFilter(field_name="paid_lesson", queryset=Lesson.objects.all(), label="Урок")
