...
class Payment(models.Model):
    ...
    session_id = models.CharField(
        max_length=255, blank=True, null=True, verbose_name="id сессии", help_text="введите id сессии"
    )
    link_for_pay = models.URLField(
        max_length=400, blank=True, null=True, verbose_name="Ссыллка на оплату", help_text="введите ссылку на оплату"
    )
